...
| [#114](https://github.com/LuigiFerronatto/TESSERA/issues/114) | absent | open | governance implementation active | branch `governance/114-evolution-auditable-templates`; PR link pending | contract tests; LongMemEval N/A | `IN_PROGRESS` |
