...
| [#93](https://github.com/LuigiFerronatto/TESSERA/issues/93) | M0 active Test Card | open | [PR #129](https://github.com/LuigiFerronatto/TESSERA/pull/129); no dependencies | [plain-language record](test-cards/93-storage-configuration-parity.md), [PR Evolution Audit](PR_EVOLUTION_93.md), [KEEP evidence](https://github.com/LuigiFerronatto/TESSERA/issues/93#issuecomment-5483152212), 13-case golden/matrix suite; current-main hidden out-of-store scan reproduced | `SMOKE_ONLY`; 272 local tests and Python 3.9/3.12, smoke, sanity, reporting CI passed; LongMemEval skipped | `IN_PROGRESS` |
