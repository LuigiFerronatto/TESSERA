...
| [#112](https://github.com/LuigiFerronatto/TESSERA/issues/112) | untracked runtime branding defect | open | active P0 branding regression | [PR #113](https://github.com/LuigiFerronatto/TESSERA/pull/113), branch `fix/112-tessera-ascii-banner` | smoke-only | `IN_PROGRESS` |
