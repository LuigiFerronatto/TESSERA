...
| [#117](https://github.com/LuigiFerronatto/TESSERA/issues/117) | absent | open | #94, #115 and #116 dependencies are satisfied; implementation PR open | project/global schema, init and inspection candidate under review; canonical merge pending | `SMOKE_ONLY`; focused matrix, full suite, sanity and CI required | `IN_PROGRESS` |
