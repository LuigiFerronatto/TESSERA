...
| [#112](https://github.com/LuigiFerronatto/TESSERA/issues/112) | untracked runtime branding defect | open | active P0 branding regression | branch `fix/112-tessera-ascii-banner`; PR link added when opened | smoke-only | `IN_PROGRESS` |
