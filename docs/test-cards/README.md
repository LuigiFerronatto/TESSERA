...
| #135 Deterministic decomposition fallback | `IN_PROGRESS` | [135-decomposition-fallback.md](135-decomposition-fallback.md) | [Issue #135](https://github.com/LuigiFerronatto/TESSERA/issues/135), [PR #216](https://github.com/LuigiFerronatto/TESSERA/pull/216), decision pending |
