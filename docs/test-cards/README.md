...
| #115 Repository layout architecture | `IN_PROGRESS` | [115-repository-layout-architecture.md](115-repository-layout-architecture.md) | [Issue #115](https://github.com/LuigiFerronatto/TESSERA/issues/115), candidate not merged |
