...
| #117 Project/global configuration and init | `IN_PROGRESS` | [117-configuration-init-discovery.md](117-configuration-init-discovery.md) | [Issue #117](https://github.com/LuigiFerronatto/TESSERA/issues/117), [ADR 0003](../adr/0003-configuration-and-store-discovery.md), [PR Evolution Audit](../PR_EVOLUTION_117.md) |
