...
| #92 Truthful write gate | `IN_PROGRESS` | [92-write-gate-integrity.md](92-write-gate-integrity.md) | [Issue #92](https://github.com/LuigiFerronatto/TESSERA/issues/92), [PR #108](https://github.com/LuigiFerronatto/TESSERA/pull/108), candidate `b38ec89` |
