...
| #135 Deterministic decomposition fallback | `PLANNED` | [135-decomposition-fallback.md](135-decomposition-fallback.md) | [Issue #135](https://github.com/LuigiFerronatto/TESSERA/issues/135), implementation PR pending |
