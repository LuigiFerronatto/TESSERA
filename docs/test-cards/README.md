...
| #155 Initialization UX and source selection | `IN_PROGRESS` | [155-init-ux.md](155-init-ux.md) | [Issue #155](https://github.com/LuigiFerronatto/TESSERA/issues/155), branch `feature/155-init-ux`, decision pending |
