...
`b475f1cd805f86cc8ad9526e563e3c6fb8409ff1`, and PR #130 finalized its lifecycle
at `055a35f4a7e8298013bcb816b30f67d9706b9516`. PR #129 was reconciled onto that
latest main before merge without rewriting the original audit history.
...
The #115 repository-layout architecture decision and lifecycle are now delivered
through PRs #128 and #130 and are preserved here; its migrations remain
unimplemented. This card does not implement packaging execution (#116, now
`READY`), a project/global registry or
