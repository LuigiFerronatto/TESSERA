...
It is intentionally **not** LongMemEval and is not intended to compare TESSERA with other memory systems. Its purpose is to catch behavioral regressions in the repository's own retrieval contract while remaining fast, offline, and reproducible.
...
The fixture covers purpose/mission retrieval, paraphrase robustness, procedural retrieval, a known operational gotcha, and a missing-evidence check.
...
The real LAO corpus and competitive benchmarks such as LongMemEval or MemPalace are intentionally kept out of this public per-PR CI path.
